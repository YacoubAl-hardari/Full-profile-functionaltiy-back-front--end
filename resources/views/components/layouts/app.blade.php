      ...
      <div class="ltr:xxl:pl-[100px] ltr:xl:pl-[30px] ltr:lg:pl-[30px] rtl:xxl:pr-[100px] rtl:xl:pr-[30px] rtl:lg:pr-[30px]">
        ...
        <div class="pt-[40px]">
            <ul>
              ...
              <li class="mb-[20px]"><a class="xl:text-[18px] text-[17px] font-medium text-primary hover:text-accent1 dark:text-white dark:hover:text-accent1 " wire:navigate href="{{ route('services') }}"><span class="inline-block ltr:mr-[10px] rtl:ml-[10px]">
